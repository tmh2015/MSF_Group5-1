...
cupid_data <- read.csv(file, header = T)
...
# The following factors (1,2,3,4) represent 1896/2001 respondents. They are retained while factors (5,6,7,8,98,99) will be recategorised as others. 
